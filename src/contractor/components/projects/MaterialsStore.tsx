...
import { X, Search, Filter, Package, ChevronRight, Plus, Minus, DollarSign } from 'lucide-react';
...
export const MaterialsStore: React.FC<MaterialsStoreProps> = ({
  ...
  //   {
  //     id: 'lumber-2x6',
  //     name: '2x6 Premium Treated Lumber',
  //     description: 'Premium grade 8ft pressure treated lumber for structural applications',
  //     category: 'Lumber & Framing Materials',
  //     subcategory: 'Dimensional Lumber',
  //     price: 12.97,
  //     unit: 'piece',
                ...
                {selectedCategory && (
                  <div>
                    ...
                    >
                      ...
                      {materialCategories[selectedCategory as keyof typeof materialCategories].map(subcategory => (
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            <h4 className="text-sm font-medium text-gray-900 pr-2">{material.name}</h4>
                            {material.savings && (
                              <span className="inline-block mt-1 text-xs px-2 py-0.5 bg-green-100 text-green-800 rounded-full">
                                Save {formatCurrency(material.savings.amount)}
                              </span>
                            )}
                          </div>
                          <button
                        ...
                        <div className="flex items-center">
                          ...
                          {material.savings && (
                            <span className="text-xs text-gray-500 ml-2">
                              (Better price at {material.savings.competitorVendor})
                            </span>
                          )}
                        </div>
                        {material.savings && (
                          <span className="text-xs text-green-600">
                            {((material.savings.amount / material.price) * 100).toFixed(0)}% savings available
                          </span>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xs text-gray-500 mt-1">
                          {material.quantity} {material.unit}s @ {formatCurrency(material.price)}/{material.unit}
                        </p>
