...
export const ChangeOrderModal: React.FC<ChangeOrderModalProps> = ({
  ...
  const submitTaskModification = async (data) => {
    const formData = new FormData();

    formData.append("taskId", data.taskId);
    formData.append("description", data.description);
    formData.append("requestedBy", data.requestedBy);
    formData.append("timeAdjustment", data.timeAdjustment);
    formData.append("costAdjustment", data.costAdjustment);
    formData.append("type", data.type || "modification");
      attachments.forEach((file) => {
        formData.append("attachments", file); // key must match multer config
      });
    ...
    try {
      const response = await axiosInstance.post("/quote/v2/change-order", formData, {
        headers: {
      ...
      console.error("Error submitting task modification:", error);
      throw error;
    }
  };
              ...
              <div>
                ...
                <div className="relative rounded-md shadow-sm">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setTimeAdjustment(parseInt(e.target.value) || 0)
                    }
                    className="block w-full pl-12 pr-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                    placeholder="0"
                    required
                  />
                </div>
              ...
              <div>
                ...
                <div className="relative rounded-md shadow-sm">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setCostAdjustment(parseFloat(e.target.value) || 0)
                    }
              ...
              <div className="flex">
                ...
                <div>
                  ...
                  <p className="text-sm text-yellow-700 mt-1">
                    This change order will require customer approval and may
                    affect the project timeline and budget.
                  </p>
                </div>
              </div>
            </div>
